import { ChevronDown, Check, MapPin, Download, Plus } from "lucide-react"
...
export function PaymentsHeader({ totalCount, totalAmount, onExport, onAddPayment }: PaymentsHeaderProps) {
  ...
  return (
    <header className="flex items-center gap-4 border-b border-border bg-card px-6 py-3">
      ...
      <div className="flex items-baseline gap-3 shrink-0">
        <span className="text-2xl font-bold tracking-tight text-foreground">Payments</span>
